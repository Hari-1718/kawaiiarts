...
const Blog = () => (
  <div className="blog-container">
    <div className="blog-card">
      ...
      <p style={{fontWeight: 'bold', color: '#b07bac', marginBottom: '10px'}}>Welcome to our creative corner! Here you'll soon find inspiring stories, behind-the-scenes peeks, and fun DIY ideas to spark your imagination.</p>
      <p>
